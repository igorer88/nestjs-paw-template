...
- `.agents/rules/dtos.md` - For DTO creation
- `.agents/rules/modules.md` - For Module creation
- `.agents/rules/services.md` - For Service creation
- `.agents/rules/controllers.md` - For Controller creation
...
1. **First**: Try NestJsMCP MCP (if configured in `.agents/mcp.json`)
2. **Second**: Use skill script:
   - `.agents/skills/nestjs-crud/scripts/generate-resource.sh <feature-name> --path <relative-base-path>`
...
- Read `.agents/rules/dtos.md` first
...
- Read `.agents/rules/services.md` first
...
- Read `.agents/rules/controllers.md` first
...
- [ ] Read `.agents/rules/dtos.md`
- [ ] Read `.agents/rules/modules.md`
- [ ] Read `.agents/rules/services.md`
- [ ] Read `.agents/rules/controllers.md`
