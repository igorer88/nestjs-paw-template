...
- For **DTOs**: Read `.agents/rules/dtos.md`
- For **Modules**: Read `.agents/rules/modules.md`
- For **Controllers**: Read `.agents/rules/controllers.md`
- For **Services**: Read `.agents/rules/services.md`
