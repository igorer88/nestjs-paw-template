...
1. Read `.agents/rules/dtos.md` before creating DTOs
2. Read `.agents/rules/modules.md` before creating module
3. Read `.agents/rules/services.md` before creating service
4. Read `.agents/rules/controllers.md` before creating controller
...
7. **Generate feature** (priority order):
   - **First**: Try NestJsMCP MCP (if configured in `.agents/mcp.json`)
